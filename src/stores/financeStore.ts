...
interface FinanceStore {
  ...
  resetAll: () => void
  hydrate: (data: Partial<Pick<FinanceStore, 'accounts' | 'transactions' | 'budgetCategories' | 'budgetGroups' | 'recurringItems' | 'goals' | 'liabilities' | 'netWorthSnapshots' | 'budgetPlans'>>) => void
}
